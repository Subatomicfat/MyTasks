...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-abcdefghijklmnopqrstuvwxyz123456789')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = ['*']  # Será substituído em produção
...
# Configurações para WhiteNoise (servir arquivos estáticos em produção)
